          ...
          <v-container>
            ...
            <v-row>
              <v-col cols="12" xl="10" lg="10" md="10" sm="12" xs="12">
                ...
                <v-btn @click="edit" outlined color="#0A66C2"><v-icon>mdi-pencil-outline</v-icon> edit </v-btn> 
                <v-btn class="mr-4 btn-color" type="submit" :disabled="invalid" color="#0A66C2">
                  submit
                </v-btn>
                </v-row>
